 ...
 */
  ...
  #define BOARD_INFO_NAME "DRAGON_CHONK (AGCM4 RAMPS 1.4.4)"
#endif

#define DRAGON_CHONK_BUTTON_JOYSTICK_ENABLE_PIN 30   
#define DRAGON_CHONK_BUTTON_UP_LED_PIN          6         
#define DRAGON_CHONK_BUTTON_DOWN_PIN            -1 // was 22     
#define DRAGON_CHONK_BUTTON_DOWN_LED_PIN        -1 // was 5          
#define DRAGON_CHONK_BUTTON_AUTOFOCUS_PIN       34          
#define DRAGON_CHONK_BUTTON_AUTOFOCUS_LED_PIN   4

#if (DRAGON_CHONK_BUTTON_JOYSTICK_ENABLE_PIN != JOY_EN_PIN)
	#error "ERROR!!  DRAGON_CHONK_BUTTON_JOYSTICK_ENABLE_PIN != JOY_EN_PIN"
#endif

#define DRAGON_CHONK_NOT_PIN_6                  ERROR_DRAGON_CHONK_REASSIGNED                   
#define DRAGON_CHONK_NOT_PIN_5                  ERROR_DRAGON_CHONK_REASSIGNED                   
#define DRAGON_CHONK_NOT_PIN_4                  ERROR_DRAGON_CHONK_REASSIGNED                   
#define DRAGON_CHONK_NOT_PIN_22                 ERROR_DRAGON_CHONK_REASSIGNED                   
#define DRAGON_CHONK_NOT_PIN_30                 ERROR_DRAGON_CHONK_REASSIGNED                   
#define DRAGON_CHONK_NOT_PIN_34                 ERROR_DRAGON_CHONK_REASSIGNED                   

//
// Servos
//
#define SERVO0_PIN                            11
//#define SERVO1_PIN                             DRAGON_CHONK_NOT_PIN_6
//#define SERVO2_PIN                             DRAGON_CHONK_NOT_PIN_5
//#define SERVO3_PIN                             DRAGON_CHONK_NOT_PIN_4
...
// Limit Switches
//
#define X_MIN_PIN                              3 // white
#define X_MAX_PIN                              2 // yellow
#define Y_MIN_PIN                             14
#define Y_MAX_PIN                             15
#define Z_MIN_PIN                             18
#define Z_MAX_PIN                             19
...
// Steppers
//
#define X_STEP_PIN                            67  // Mega/Due:54 - AGCM4:67 (A0) -- blue
#define X_DIR_PIN                             68  // Mega/Due:55 - AGCM4:68 (A1) -- green
#define X_ENABLE_PIN                          38  // orange
#ifndef X_CS_PIN
  #define X_CS_PIN                            47
#endif
...
#define Z_STEP_PIN                            46 // blue
#define Z_DIR_PIN                             48 // green
#define Z_ENABLE_PIN                          54  // Mega/Due:62 - AGCM4:54 (A8) -- orange
#ifndef Z_CS_PIN
  #define Z_CS_PIN                            32
#endif
...
//#define E1_DIR_PIN                            DRAGON_CHONK_NOT_PIN_34
//#define E1_ENABLE_PIN                         DRAGON_CHONK_NOT_PIN_30
#ifndef E1_CS_PIN
  //#define E1_CS_PIN                           DRAGON_CHONK_NOT_PIN_22
#endif
...
#define LED_PIN                               13
...
#ifndef FILWIDTH_PIN
  //#define FILWIDTH_PIN                         DRAGON_CHONK_NOT_PIN_5  // Analog Input on AUX2
#endif
  ...
  #define PS_ON_PIN                           39
    ...
    #define CASE_LIGHT_PIN                     DRAGON_CHONK_NOT_PIN_6  // Hardware PWM
  #endif
#endif
...
//
    ...
    #define SPINDLE_LASER_PWM_PIN              DRAGON_CHONK_NOT_PIN_6  // Hardware PWM
    #define SPINDLE_LASER_ENA_PIN              DRAGON_CHONK_NOT_PIN_4  // Pullup or pulldown!
    #define SPINDLE_DIR_PIN                    DRAGON_CHONK_NOT_PIN_5
  #else
...
//
  ...
  //#define E1_HARDWARE_SERIAL Serial1
    ...
    #define Z2_SERIAL_TX_PIN                  DRAGON_CHONK_NOT_PIN_22
  #endif
...
//
  ...
  //
    ...
    #define TFTGLCD_CS               EXP2_05_PIN
      ...
      CONTROLLER_WARNING("DRAGON_CHONK", "ZONESTAR_LCD", " Plugs into AUX2 but GND and 5V must be swapped.")
  ...
  //
      ...
      #define BTN_EN1                         DRAGON_CHONK_NOT_PIN_22
      #define BTN_EN2                          7
  ...
  CONTROLLER_WARNING("DRAGON_CHONK", "LCD_FYSETC_TFT81050")
